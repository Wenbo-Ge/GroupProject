...
public class GeoCityDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        latitude.setText(cityList.get(index).getLatitude());

        TextView longitude = (TextView)result.findViewById(R.id.longitude);
        longitude.setText(cityList.get(index).getLongitude());
...
/*
        int idColIndex = results.getColumnIndex(GeoCityDBOpener.COL_ID);
        int messageIndex = results.getColumnIndex(GeoCityDBOpener.COL_MESSAGE);
        int isSentIndex = results.getColumnIndex(GeoCityDBOpener.COL_ISSENT);
