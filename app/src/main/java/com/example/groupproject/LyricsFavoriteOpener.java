...
public class LyricsFavoriteOpener extends SQLiteOpenHelper {

    protected final static String DATABASE_NAME = "LyricsFavoriteDB";
    ...
    public LyricsFavoriteOpener(Context ctx)
    {
